...
public class ManyToManyFieldTargetRule : DiagnosticAnalyzer
{
    private static readonly DiagnosticDescriptor RuleNotDocument = new(
        id: "CRBSH029",
        title: "ManyToManyField target does not extend CrabshellDocument",
        messageFormat: "[ManyToManyField] on '{0}' points to '{1}' which does not extend CrabshellDocument",
        category: "Crabshell",
    ...
    private static readonly DiagnosticDescriptor RuleDuplicateTarget = new(
        id: "CRBSH030",
        title: "Duplicate ManyToManyField target type",
        messageFormat: "'{0}' is a duplicate [ManyToManyField] pointing to '{1}' — another property in this collection already targets the same type",
        category: "Crabshell",
    ...
    private static void Analyze(SymbolAnalysisContext context)
    {
        ...
        {
            var attr = prop.GetAttributes().FirstOrDefault(a => a.AttributeClass?.Name == "ManyToManyFieldAttribute");
            ...
            // CRBSH029 — target must extend CrabshellDocument
            ...
            // CRBSH030 — duplicate target type
